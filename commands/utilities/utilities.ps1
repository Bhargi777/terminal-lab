...
switch ($Sub) {
    "whoami" {
        Write-Host "Name     : $(Get-BhargiConfigValue -Name 'BHARGI_DISPLAY_NAME' -Default 'Anonymous')"
    ...
    { $_ -in "-h", "--help", "help" } {
        Write-Host "bhargi utilities [subcommand]"
